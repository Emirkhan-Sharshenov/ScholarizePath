...
export default function ComparePage() {
    ...
    const formattedScholarships = schList.map((sch, idx) => {
        ...
        // Считается лучшим, если это максимальная сумма ИЛИ стипендия Fully Funded
        ...
        <div className="min-h-screen bg-[rgb(246,247,251)] p-4 font-sans md:p-8 text-slate-800">
            <div className="mx-auto max-w-7xl">
                ...
                <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <div className="inline-flex rounded-xl bg-slate-200/70 p-1">
                        <button
                            ...
                            className={`flex items-center gap-2 rounded-lg px-4 py-2 text-xs font-semibold transition ${isUniActive
                ...
                {items.length === 0 ? (
                    ...
                    /* Strict Row-Aligned Comparison Grid */
                    <div className="overflow-x-auto rounded-2xl border border-slate-200 bg-white shadow-sm">
                        ...
                        >
                            ...
                            {/* РЯД 5: Acceptance Rate / Award Details (С ВЫДЕЛЕНИЕМ ЛУЧШЕГО) */}
                            <div className="p-4 bg-slate-50/50 text-xs font-semibold text-slate-600 flex items-center">
                            ...
                            {/* РЯД 7: Application Deadline (Только для Стипендий) */}
                            {!isUniActive && (
                                <>
                                    <div className="p-4 bg-slate-50/50 text-xs font-semibold text-slate-600 flex items-center">

...
export default function Sidebar() {
  ...
  return (
    <aside
      className={`fixed left-0 top-0 z-50 h-screen bg-[rgb(252,253,255)] flex flex-col items-start transition-[width] duration-300 ease-in-out ${collapsed ? "w-20" : "w-64"
        }`}
    >
      {/* Кнопка Hamburger — та же px-3 обёртка и та же w-14 зона, что и у иконок ниже */}

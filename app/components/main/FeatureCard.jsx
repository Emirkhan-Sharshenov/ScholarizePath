export default function FeatureCard({ icon, badgeText, title, description, onExplore }) {
    return (
        <article className="group relative h-full">
            <button
                ...
                className="w-full h-full text-left cursor-pointer bg-white rounded-2xl p-5 sm:p-6 md:p-7 shadow-sm border border-slate-100 hover:border-blue-200 transition-all duration-300 hover:shadow-xl hover:-translate-y-1 flex flex-col justify-between relative overflow-hidden focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2"
            >

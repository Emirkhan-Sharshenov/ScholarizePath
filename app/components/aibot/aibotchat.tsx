    ...
    const suggestedQuestions = [
        {
            id: 1,
            icon: GraduationCap,
            text: 'Find scholarships for MS in Canada',
        },
        {
            id: 2,
            icon: Building2,
            text: 'Top universities for Computer Science',
        },
        {
            id: 3,
            icon: Award,
            text: 'What are my chances of getting a scholarship?',
        },
        {
            id: 4,
            icon: FileCheck,
            text: 'How to strengthen my application?',
        },
    ];
        ...
        <div className="w-full max-w-4xl mx-auto bg-white rounded-3xl shadow-sm border border-slate-100 p-6 md:p-8 font-sans flex flex-col justify-between min-h-[700px]">
                    ...
                    <div className="flex items-center gap-4">
                        <div className="relative w-16 h-16 rounded-full bg-gradient-to-tr from-blue-100 to-indigo-100 p-0.5 shadow-sm">
                            <div className="w-full h-full rounded-full bg-white flex items-center justify-center overflow-hidden relative">
                                ...
                                <Image
                                    src="/images/aibot/bot-avatar.png"
                                    alt="AI Assistant"
                                    width={64}
                                    height={64}
                ...
                <div className="space-y-4 pt-2">
                    ...
                    <div className="flex flex-col items-end">
                        <div className="max-w-[85%] sm:max-w-md bg-slate-100/80 rounded-2xl rounded-tr-xs px-4 py-3 text-slate-800 text-xs md:text-sm">
                            I want to study MS in Computer Science in Canada with a scholarship.
                        </div>
                    ...
                    <div className="flex items-start gap-3 max-w-[90%] sm:max-w-xl">
                        ...
                        <div>
                            <div className="bg-blue-50/60 rounded-2xl rounded-tl-xs px-4 py-3 text-slate-800 text-xs md:text-sm leading-relaxed">
                                Great choice, Ayesha! 🎓 Canada has excellent universities and plenty of scholarship opportunities for MS in Computer Science. Based on your profile, here are some personalized recommendations for you.
                            </div>
                            <span className="text-[10px] text-slate-400 mt-1 pl-1 block">10:30 AM</span>
                        </div>
                    </div>
            ...
            <div className="space-y-4 pt-6">
                ...
                <div>
                    ...
                    {/* Responsive Grid for Suggestion Cards */}
                        ...
                        {suggestedQuestions.map((item) => {
                            ...
                            return (
                                <button
                                    ...
                                    className="flex items-center gap-3 p-3 bg-slate-50/70 hover:bg-blue-50/50 border border-slate-100 hover:border-blue-200 rounded-xl transition text-left group"
                                >
                ...
                <div className="relative bg-slate-50/60 rounded-2xl border border-slate-200/80 p-3 shadow-xs">
                    ...
                    <div className="flex items-center justify-between pt-2">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <button className="w-9 h-9 rounded-full bg-blue-600 hover:bg-blue-700 text-white flex items-center justify-center shadow-md transition active:scale-95">
